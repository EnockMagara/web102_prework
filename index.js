...
const unfundedDescription = `There are currently ${unfundedGamesCount.length} game${unfundedGamesCount.length === 1 ? '' : 's'} that ${unfundedGamesCount.length === 1 ? 'has' : 'have'} not yet met ${unfundedGamesCount.length === 1 ? 'its' : 'their'} funding goal.`;
